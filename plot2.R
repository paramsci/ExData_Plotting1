...
# (the output is sent to "./Project_1/plot2.png"):

png(file = "./Project_1/plot2.png") # note that it is not necessary to specify
...
plot(days$Date.Time, days$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
dev.off()